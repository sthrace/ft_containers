...
void	get_allocator_test(void)
{
	...
	psize = sizeof(_NAMESPACE::map<char,int>::value_type)*5;
...
void	lower_upper_bound_test(void)
{
	...
	// print content:
	for (_NAMESPACE::map<char,int>::iterator it=mymap.begin(); it!=mymap.end(); ++it)
...
void	value_comp_test(void)
{
	...
	_NAMESPACE::pair<char,int> highest = *mymap.rbegin();          // last element

	_NAMESPACE::map<char,int>::iterator it = mymap.begin();
	do {
		std::cout << it->first << " => " << it->second << '\n';
...
void	key_comp_test(void)
{
	...
	_NAMESPACE::map<char,int>::key_compare mycomp = mymap.key_comp();
...
void	insert_test(void)
{
	...
	mymap.insert ( _NAMESPACE::pair<char,int>('a',100) );
	mymap.insert ( _NAMESPACE::pair<char,int>('z',200) );

	_NAMESPACE::pair<_NAMESPACE::map<char,int>::iterator,bool> ret;
	ret = mymap.insert ( _NAMESPACE::pair<char,int>('z',500) );
	if (ret.second==false) {
	...
	_NAMESPACE::map<char,int>::iterator it = mymap.begin();
	mymap.insert (it, _NAMESPACE::pair<char,int>('b',300));  // max efficiency inserting
	mymap.insert (it, _NAMESPACE::pair<char,int>('c',400));  // no max efficiency inserting
...
void	operator_index_test(void)
{
	_NAMESPACE::map<char,std::string> mymap;
